...
static const int dead_stats_off_delta =
	offsetof(struct bfq_group, dead_stats) -
...
/**
 * bfq_pd_offline - destroy @bfqg.
 * @bfqg: the group being destroyed.
 *
 * Destroy @bfqg, making sure that it is not referenced from its
 * parent.  blkio already grabs the queue_lock for us, so no need to
 * use RCU-based magic
 */
...
static u64 bfq_io_show_weight(struct cgroup_subsys_state *css,
...
static int bfq_io_show_weight_dfl(struct seq_file *sf, void *v)
{
...
static int bfq_io_set_weight(struct cgroup_subsys_state *css,
					struct cftype *cftype,
					u64 val)
{
	struct blkcg *blkcg = css_to_blkcg(css);
...
static ssize_t bfq_io_set_weight_dfl(struct kernfs_open_file *of,
					     char *buf, size_t nbytes,
					     loff_t off)
{
	/* First unsigned long found in the file is used */
	return bfq_io_set_weight(of_css(of), NULL,
...
static struct cftype bfq_io_files_dfl[] = {
	{
		.name = "weight",
		.flags = CFTYPE_NOT_ON_ROOT,
		.seq_show = bfq_io_show_weight_dfl,
		.write = bfq_io_set_weight_dfl,
	},
	{} /* terminate */
};

static struct cftype bfq_io_files[] = {
	{
		.name = "bfq.weight",
		.read_u64 = bfq_io_show_weight,
		.write_u64 = bfq_io_set_weight,
	},
...
static struct blkcg_policy blkcg_policy_bfq = {
       .dfl_cftypes            = bfq_io_files_dfl,
       .legacy_cftypes         = bfq_io_files,
